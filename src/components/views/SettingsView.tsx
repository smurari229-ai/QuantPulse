    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-5 space-y-4 font-mono text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div><label className="text-slate-400 text-[10px] block mb-1">MAX POSITION NOTIONAL ($)</label><input type="number" value={config.maxPositionSizeNotional} onChange={(e) => setConfig({ ...config, maxPositionSizeNotional: Number(e.target.value) })} className="w-full bg-slate-950 border border-slate-800 rounded px-2.5 py-1.5 text-slate-200 text-xs focus:outline-none focus:border-blue-500" /><span className="text-[10px] text-slate-500">Gate #1 Ceiling</span></div>
          <div><label className="text-slate-400 text-[10px] block mb-1">MAX PORTFOLIO EXPOSURE (%)</label><input type="number" value={config.maxPortfolioExposurePct} onChange={(e) => setConfig({ ...config, maxPortfolioExposurePct: Number(e.target.value) })} className="w-full bg-slate-950 border border-slate-800 rounded px-2.5 py-1.5 text-slate-200 text-xs focus:outline-none focus:border-blue-500" /><span className="text-[10px] text-slate-500">Gate #2 Ceiling</span></div>
          <div><label className="text-slate-400 text-[10px] block mb-1">MAX DAILY LOSS LIMIT (%)</label><input type="number" value={config.maxDailyLossPct} onChange={(e) => setConfig({ ...config, maxDailyLossPct: Number(e.target.value) })} className="w-full bg-slate-950 border border-slate-800 rounded px-2.5 py-1.5 text-slate-200 text-xs focus:outline-none focus:border-blue-500" /><span className="text-[10px] text-slate-500">Gate #3 Circuit Breaker</span></div>
          <div><label className="text-slate-400 text-[10px] block mb-1">MAX DRAWDOWN HALT (%)</label><input type="number" value={config.maxDrawdownHaltPct} onChange={(e) => setConfig({ ...config, maxDrawdownHaltPct: Number(e.target.value) })} className="w-full bg-slate-950 border border-slate-800 rounded px-2.5 py-1.5 text-slate-200 text-xs focus:outline-none focus:border-blue-500" /><span className="text-[10px] text-slate-500">Gate #4 Ceiling</span></div>
          <div><label className="text-slate-400 text-[10px] block mb-1">MAX SPREAD FILTER (BPS)</label><input type="number" value={config.maxSpreadBps} onChange={(e) => setConfig({ ...config, maxSpreadBps: Number(e.target.value) })} className="w-full bg-slate-950 border border-slate-800 rounded px-2.5 py-1.5 text-slate-200 text-xs focus:outline-none focus:border-blue-500" /><span className="text-[10px] text-slate-500">Gate #9 Ceiling</span></div>
          <div><label className="text-slate-400 text-[10px] block mb-1">MAX DATA STALENESS (MS)</label><input type="number" value={config.maxDataStalenessMs} onChange={(e) => setConfig({ ...config, maxDataStalenessMs: Number(e.target.value) })} className="w-full bg-slate-950 border border-slate-800 rounded px-2.5 py-1.5 text-slate-200 text-xs focus:outline-none focus:border-blue-500" /><span className="text-[10px] text-slate-500">Gate #11 Ceiling</span></div>
        </div>
      </div>
